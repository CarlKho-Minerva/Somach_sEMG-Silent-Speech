...
\keywords{silent speech interface \and negative result \and surface electromyography \and electrode placement \and consumer hardware \and sEMG \and lingual-mandibular}
...
\begin{itemize}
    ...
    \item \textbf{Jou et al.\ (2006; 2007)}~\cite{jou2006,jou2007}: NASA Ames demonstrated 92\% mean accuracy (2007 ICASSP) on ``mouthed'' speech, where articulators moved normally but no sound was produced. They reported an inability to decode purely ``mentally rehearsed'' inner speech due to absence of detectable sEMG activity. This mouthed-vs-imagined boundary defines the floor for what peripheral sEMG can capture.
    ...
    \item \textbf{Sae Jong et al.\ (2018)}~\cite{saejong2018}: Investigated channel reduction strategies for sEMG-based speech recognition, demonstrating that fewer electrode channels can still capture discriminative articulatory information when placed on complementary muscle groups.
...
Negative results are underreported in BCI and SSI literature. Lotte et al.\ (2020), writing from a major BCI society workshop, explicitly stated that ``the report of negative results is equally valuable for its further progress''~\cite{lotte2020}. Nimpf and Keays (2020) argued that negative results are essential to prevent wasteful duplication of effort across research groups~\cite{fessenden2019}. I report this failure deliberately because:
\begin{enumerate}
...
Thanks to Prof.\ Watson for advising this work. This work was partially supported by the Minerva University capstone program (CP193/CP194).
...
% TODO: Replace XXXX.XXXXX with Paper 1's arXiv ID once assigned. Submit Paper 1 first, then update.
C.~V.~L.\ Kho, ``Curriculum learning for silent speech classification: A proof-of-concept \$40 two-channel sEMG system,'' \emph{arXiv preprint}, arXiv:XXXX.XXXXX (submitted concurrently), 2026.
...
\bibitem{ala2018}
% Gray literature (clinical guideline, not peer-reviewed). Acceptable for illustrative
% reference to clinical practice context. If a peer-reviewed alternative is preferred,
% see: Blitzer et al., Laryngoscope, 2015 (LEMG clinical applications review).
...
% VERIFIED 2026-03-21: DOI 10.15252/embr.201949775. Online Dec 2019, print Jan 2020.
S.\ Nimpf and D.~A.\ Keays, ``Why (and how) we should publish negative data,'' \emph{EMBO Reports}, vol.~21, no.~1, e49775, 2020.
...
\bibitem{saejong2018}
% VERIFIED 2026-03-21: IEEE ECTI-CON 2018, DOI 10.1109/ECTICon.2018.8619947.
N.\ Sae Jong, P.\ Phukpattaranont, and C.\ Limsakul, ``Channel reduction in speech recognition system based on surface electromyography,'' in \emph{Proc.\ 15th IEEE ECTI-CON}, 2018.
